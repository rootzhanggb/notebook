...
case $db in
	yes|y|Y|YES)  
		...
		#mysql -e "CREATE DATABASE if not exists test DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;"
		;;
	no|n|N|NO)
        echo "uninstall"
			#mysql -h$db_ip -P$db_port -u$db_user -p$db_password -e "CREATE DATABASE if not exists test DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;"
